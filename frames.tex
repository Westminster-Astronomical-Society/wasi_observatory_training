...
\begin{frame}[t]{\insertsubsectionhead\ (observatory log)}
\begin{columns}[T]
  \column{0.45\textwidth}
    \begin{figure}[h]
...
% -----------------------------------------------
\begin{frame}[t]{\insertsubsectionhead\ (check date \& time)}
    \begin{columns}[T]
    \column{0.55\textwidth}
      \begin{figure}[h]
...
% -----------------------------------------------
\begin{frame}[t]{\insertsubsectionhead\ (set date \& time)}
  \begin{columns}[T]
  \column{0.55\textwidth}
  \begin{figure}[ht]
  ...
  \vspace{\fill}
  \begin{subfigure}{0.67\textwidth}
      \frame{\includegraphics[width=\textwidth]{keypad/AP_menu-setup-1.pdf}}
    \caption{location}
  \end{subfigure}
\end{figure}
  \column{0.45\textwidth}
